    ...
    <Section  class="ccontainer None pelling-bolt-main-design" style=""  >
                        ...
                        <div class="row resp_grid grid-container-960">
                            ...
                            <div class="span6 col-md-6  col-sm-6  col-xs-12 col-sm-pull-6">
                                ...
                                <section class="ccontainer" style="">
                                    ...
                                    <div class="ctext">
                                        <p>Access what you need, when and where you need it. QuickBooks securely stores your data and keeps it up-to-date across all your devices.</p>
                                    </div>
                                    <div class="ccta cta-align-left" data-qe-id="#">
                                        <a class="ctaprimary ctaleft" href="#pricing" data-wa-link="hero-buynow" data-di-id="#hero-buynow">Buy Now<span class="visually-hidden">Buy QuickBooks Online Now</span></a>
                                    </div>
                                    <div class="ccta cta-align-left" data-qe-id="#">
                    ...
                    <div class="row grid-container-960">
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="ctext">
                                ...
                                <p style="text-align: center;">Run your business on the go. QuickBooks keeps your accounts organised in the cloud. Track sales, send invoices and see how your business is doing any time and anywhere.</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="cimage clearfix ">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="ctext">
                                ...
                                <p style="text-align: center;">QuickBooks uses advanced safeguards and encryption to keep your data private and protected.</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            <div class="cimage clearfix ">
                                ...
                                <div class="llp-faq-section" data-di-id="di-id-3d8d9bfe-36e41fcb">
                                    ...
                                    <div class="llp-faq-content">
                                        <div class="ctext">
                                            ...
                                            <p>There is nothing saved on your computer, and there are no disks to load. Log in on any device, and jump right into your QuickBooks Online account. Your data and settings are right there, stored safely in the cloud.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="cfaq-qa">
                            <div>
                                <div class="llp-faq-section" data-di-id="di-id-61eed51d-ef079c03">
                                    ...
                                    <div class="llp-faq-content">
                                        <div class="ctext">
                                            <p>When you work in the cloud, you’re always using the latest version of QuickBooks Online. Because you're working online, you can pick up where you left off with the latest data on all your devices.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="cfaq-qa cfaq-qa-d-bottom">
                            <div>
                                <div class="llp-faq-section" data-di-id="di-id-9e25d923-6658c840">
                                    ...
                                    <div class="llp-faq-content">
                                        <div class="ctext">
                                            <p>When you use QuickBooks Online, your data is stored on our servers in the cloud. We know that data is one of your company's most valuable assets, so we go to great lengths to protect it.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="ccontainer None pelling-bolt-main-design__green-banner beams" style="">
            <section class="ccontainer None ss-bullets-columns" style="">
                <div class="content-container">
                    <div class="ctext">
                        <h3 style="text-align: center;">See how QuickBooks can work for your business</h3>
                    </div>
