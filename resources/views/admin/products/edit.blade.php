                ...
                <div class="form-group {{ $errors->has('subcategory_id') ? 'has-error' : '' }}">
                    ...
                    <select name="subcategory_id" id="subcategory_id" class="form-control">
                        ...
                        @foreach($subcategories as $id => $subcategories)
                            <option value="{{ $id }}" {{ (old('subcategory_id') == $id || isset($product) && $product->subcategory->id == $id) ? 'selected' : '' }}>{{ $subcategories }}</option>
                        @endforeach
                    </select>
                    ...
                    <div class="form-check" id="status">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                ...
                                {{ isset($product) && $product->is_latest == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-2">
                                ...
                                {{ isset($product) && $product->is_active == 1 ? 'checked' : '' }}>
